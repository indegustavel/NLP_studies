...
Apesar de ser uma pessoa que se sente melhor em posições não tão técnicas e sim mais estratégicas, é de extrema importância entender o que está acontecendo por "baixo dos panos". Dessa forma, decidi iniciar meus estudos em NLP (e sem vibe coding, usando I.A apenas para explicações).
